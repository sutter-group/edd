            ...
            <div class="mk-slider-content" style="float:<?php if($image_align == 'left') { echo 'right';} else echo 'left'; ?>;">
                ...
                <div class="mk-slider-content-inside">
                    ...
                    <ul class="mk-tab-slider-share">
                        <li><a class="facebook-share" data-title="<?php echo esc_attr($title); ?>" data-url="<?php echo $page_permalink; ?>" href="#"><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true, 'mk-icon-facebook'); ?></a></li>
                        <li><a class="twitter-share" data-title="<?php echo esc_attr($title); ?>" data-url="<?php echo $page_permalink; ?>" href="#"><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true, 'mk-moon-twitter'); ?></a></li>
                        <li><a class="googleplus-share" data-title="<?php echo esc_attr($title); ?>" data-url="<?php echo $page_permalink; ?>" href="#"><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true, 'mk-icon-google-plus'); ?></a></li>
                    </ul>
                    <?php } ?>
