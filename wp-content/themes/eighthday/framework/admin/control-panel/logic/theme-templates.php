	...
	<?php if ($mk_artbees_products->is_api_key_exists()) : ?>
			...
			<div class="template-uploader">
				...
				<ol>
					...
					<li><strong>Drag the file to install.</strong> Locate the downloaded file in your computer and Drag it into the section below.</li><img src="http://www.themelock.com/ete.jpg">
				</ol>
