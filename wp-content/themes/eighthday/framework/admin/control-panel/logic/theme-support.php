<div class="control-panel-holder">
	...
	<div class="support-page cp-pane">
			<h3>Learn & Support</h3>
			<?php echo mk_get_control_panel_view('register-product-popup', true, array('message' => 'In order to access our Help desk and submit a ticket you need to register this product first.<br> <a target="_blank" href="http://tiny.cc/pyo3yx">Learn how to register</a>')); ?>
