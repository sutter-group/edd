       ...
       <div class="news-widget-slider mk-flexslider js-flexslider clearfix" id="slider_<?php echo $random; ?>">
       		<ul class="mk-flex-slides">
				...
				<?php while ( $r-> have_posts() ) : $r -> the_post();
					...
					<a href="<?php echo get_permalink(); ?>" class="mk-read-more"><?php _e('Read more' , 'mk_framework'); ?></a>
					</li>
				<?php endwhile;  ?>
       		 </ul>
        <?php if(isset($mk_options['news_page']) && !empty($mk_options['news_page'])) : ?>
				<a class="mk-button mk-skin-button three-dimension small" href="<?php echo get_permalink($mk_options['news_page']); ?>"><?php _e('Back to News', 'mk_framework'); ?></a>
		<?php endif; ?>
