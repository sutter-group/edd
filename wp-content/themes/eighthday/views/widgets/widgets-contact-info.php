...
?>
			...
			<?php if ( !empty( $person ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-moon-user-7'); ?><span itemprop="name"><?php echo $person;?></span></li><?php endif;?>	
			<?php if ( !empty( $company ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-moon-office'); ?><span itemprop="jobTitle"><?php echo $company;?></span></li><?php endif;?>
			<?php if ( !empty( $address ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-icon-home'); ?><span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress"><?php echo $address;?></span></li><?php endif;?>
			<?php if ( !empty( $phone ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-icon-phone'); ?><span><?php echo $phone;?></span></li><?php endif;?>
			<?php if ( !empty( $fax ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-icon-print'); ?><span><?php echo $fax;?></span></li><?php endif;?>
			<?php if ( !empty( $email ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-icon-envelope'); ?><span><a itemprop="email" href="mailto:<?php echo antispambot($email); ?>"><?php echo antispambot($email);?></a></span></li><?php endif;?>
			<?php if ( !empty( $website ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-icon-globe'); ?><span><a href="<?php echo $website; ?>" itemprop="url"><?php echo $website; ?></a></span></li><?php endif;?>
			<?php if ( !empty( $skype ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-moon-skype'); ?><span><a href="skype:<?php echo $skype; ?>?call"><?php echo $skype;?></a></span></li><?php endif;?>
			</ul>
		<?php
		echo $after_widget; 
